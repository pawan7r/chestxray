...
training_data = 'chest_xray/train_dir'
testing_data = 'chest_xray/test_dir' #Give our training and testing path 

for each_layer in vgg_model.layers: 
	each_layer.trainable = False #Set the trainable as False, So that all the layers would not be trained. 
classes = glob('chest_xray/train_dir/*') #Finding how many classes present in our train dataset. 
...
training_set = train_datagen.flow_from_directory('chest_xray/train_dir', #inserting the images. 
												target_size = (224, 224), 
												batch_size = 4, 
												class_mode = 'categorical') 
test_set = testing_datagen.flow_from_directory('chest_xray/test_dir', 
											target_size = (224, 224), 
											batch_size = 4, 
											class_mode = 'categorical') 
